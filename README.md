...
**NOTES FOR THE USER**: Before performing Wavelet-based filtering procedures be sure you have MATLAB (latest version: R2022b) and the Python's library **matlabengine** already installed on your device (they are not included in the project's requirements). <br>
