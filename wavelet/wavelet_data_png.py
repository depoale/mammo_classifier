...
dataset_path_Train_0 = './data_png/Train/0'
dataset_path_Train_1 = './data_png/Train/1'
dataset_path_Test_0 = './data_png/Test/0'
dataset_path_Test_1 = './data_png/Test/1'


names_Train_0 = os.listdir(dataset_path_Train_0)
names_Train_1 = os.listdir(dataset_path_Train_1)
names_Test_0 = os.listdir(dataset_path_Test_0)
names_Test_1 = os.listdir(dataset_path_Test_1)

for name in names_Train_0:
    I = eng.imread(f'./data_png/Train/0/{name}')
    I = np.asarray(I)
    ...
    plt.imsave(f'./data_png_WAVELET/Train/0/{name}.png', I_rec, cmap='gray', format='png')
    #plt.show()


for name in names_Train_1:
    I = eng.imread(f'./data_png/Train/1/{name}')
    I = np.asarray(I)
    ...
    #plt.figure('rec_wavelet')
    #plt.imshow(I_rec, cmap='gray')
    plt.imsave(f'./data_png_WAVELET/Train/1/{name}.png', I_rec, cmap='gray', format='png')
    #plt.show()


for name in names_Test_0:
    I = eng.imread(f'./data_png/Test/0/{name}')
    I = np.asarray(I)
    ...
    #plt.figure('rec_wavelet')
    #plt.imshow(I_rec, cmap='gray')
    plt.imsave(f'./data_png_WAVELET/Test/0/{name}.png', I_rec, cmap='gray', format='png')
    #plt.show()


for name in names_Test_1:
    I = eng.imread(f'./data_png/Test/1/{name}')
    I = np.asarray(I)
    ...
    #plt.figure('rec_wavelet')
    #plt.imshow(I_rec, cmap='gray')
    plt.imsave(f'./data_png_WAVELET/Test/1/{name}.png', I_rec, cmap='gray', format='png')
    #plt.show()
